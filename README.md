...
# Add To Your Server
To simply add this bot to your server as is, [have a server admin click this link](https://discordapp.com/oauth2/authorize?client_id=376921158420791297&scope=bot&permissions=285760) and authorize the bot on that server. This adds the instance that I run on my servers to your server as well, instead of going through the trouble of running your own bot. It will be sufficient for most basic purposes, you just won't be able to fully use the !report feature, because you won't be in my bot_admin file.
...
diceloop.sh seems much less necessary now that it's not 2018 anymore. I haven't deleted it though, just in case we have different problems. Live your dream.
